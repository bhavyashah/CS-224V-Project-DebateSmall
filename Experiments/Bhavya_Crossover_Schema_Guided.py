...
Usage:
    python crossover_debate.py --turns 3 --prop-model 4o-mini --opp-model 4o-mini --prop-arch baseline --opp-arch enhanced
    python crossover_debate.py -t 1 -pm o1 -om 4o-mini -pa baseline -oa enhanced
    python crossover_debate.py -t 3 -pm 4o-mini -om 4o-mini -pa baseline -oa enhanced --motion "This house would ban social media"

Flags:
    -t, --turns: Number of turns (1, 2, or 3) - default: 3
    -pm, --prop-model: Model for Proposition (4o, 4o-mini, o1, o1-mini) - default: 4o-mini
    -om, --opp-model: Model for Opposition (4o, 4o-mini, o1, o1-mini) - default: 4o-mini
    -pa, --prop-arch: Architecture for Proposition (enhanced, baseline) - default: baseline
    -oa, --opp-arch: Architecture for Opposition (enhanced, baseline) - default: enhanced
    -jm, --judge-model: Judge model (o3, o1) - default: o3
    -m, --motion: Debate motion - default: "This house would make voting mandatory"
...
Examples:
  ...
  python crossover_debate.py -t 2 -pm 4o-mini -om 4o-mini -pa baseline -oa enhanced
    ...
    parser.add_argument('-pa', '--prop-arch', type=str, default='baseline',
                        choices=['enhanced', 'baseline', 'schema_guided'],
