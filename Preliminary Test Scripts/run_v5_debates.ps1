...
$models = @("4o", "4o-mini")
$outputFile = "v5_architecture_results.csv"
$tempDir = "C:\Users\Bhavya Shah\OneDrive\Desktop\Kyle\temp_debates_v5"
...
# Remove-Item $outputFile -ErrorAction SilentlyContinue # Don't delete if we want to append, but here we want a fresh run

Write-Host "=== Running All 20 Debates in Parallel (v5 Architecture) ===" -ForegroundColor Cyan
